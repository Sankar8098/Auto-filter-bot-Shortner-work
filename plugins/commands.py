...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/SK_MoviesOffl')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/SK_MoviesOffl"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/SK_MoviesOffl')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
